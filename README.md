...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/7YlgRUEwSl)
...
```sh
npx nx serve react-naver-map-sdk
```

To create a production bundle:

```sh
npx nx build react-naver-map-sdk
```

To see all available targets to run for a project, run:

```sh
npx nx show project react-naver-map-sdk
```
